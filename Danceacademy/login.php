...
<div class="container-fluid">
 ...
 <div class="clear"></div>
	 ...
	 <form action="addlogin.php" method="POST" enctype="multipart/form-data">
	  <div class="view" style="background-image: url('images/p56.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
	...
	<div class="loginbox">
			...
			<input type="password" class="form-control" id="pawd" name="password" placeholder="password">
