...
<div class="container-fluid">
	<div class="container p-3 my-3 border"><div class="container_12">
        <div class="grid_12">
   <img src="images/r2.png"><ul class="nav navbar-right">
 
   <li id="dropdown-user" class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right" aria-expanded="false">
                          
                             <img class="img-circle img-user media-object" src="images/i1.jpg" height="50" width="50">
                                                         
                           
                            <div class="username hidden-xs"><p style="color:red;">HELLO 
							<?php
	                            echo $temp;
	                                ?></p></div>
                        </a> 
    ...
    <div class="clear"></div>
		...
		<div class="navbar-header"><img src="images/l1.png">
			...
			<!--li class="nav navbar-right"><a href="login.html">
				<button type="button" class="btn btn-success">Sign</button></a></li>-->
...
<section class="slider_wrapper">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="Images/p11.jpg" alt="Los Angeles">
    </div>
    ...
    <div class="item">
      <img src="Images/p998.jpg" alt="New York">
    </div>
  </div>
  </div>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - October 06, 2014!</div>
  <div class="container_12">
    ...
    <div class="grid_5 prefix_1 gallery">
      <a href="images/p100.jpg" class="gall_item">
