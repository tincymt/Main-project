...
<br>
 <form action="addleave_usr.php" method="POST" enctype="multipart/form-data">
 ...
 <div class="view" style="background-image: url('../images/p468.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <h2><div class="panel-heading"><center>Apply Leave</center></div></h2>
      <div class="panel-body">
               ...
               <div class="input-group form-group">
														</div><p style="color:white">Date
										<input  min="2020-01-01" max="2030-01-01" required class="form-control" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" name="dte"/>	
			    ...
			    <div class="thumbnail">
                     ...
                     <div class="iq-blog-entry white-bg">
                        <div class="iq-entry-image clearfix">
                           <img class="img-fluid" src="../Images/p138.jpg" alt="#"></a>
			    ...
			    <div class="thumbnail">
                     ...
                     <div class="iq-blog-entry white-bg">
                        <div class="iq-entry-image clearfix">
                           <img class="img-fluid" src="../Images/p121.png" alt="#"></a>
			    ...
			    <div class="thumbnail">
                     ...
                     <div class="iq-blog-entry white-bg">
                        <div class="iq-entry-image clearfix">
                            <img class="img-fluid" src="../Images/p125.png" alt="#"></a>
