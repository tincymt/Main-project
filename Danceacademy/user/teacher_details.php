...
{
$get_id=$_GET['id'];
$get_post="select * from tbl_teacher where teacher_id='$get_id'";
		...
		<br>
	  	...
	  	<div class="navigation ">
			<h2><div class="panel-heading"> 
				<center>...TEACHER PROFILE...</center></div></h2></div>
              ...
              <!--Form-->
					...
					<div class="card o-hidden border-0 shadow-lg my-5">
						...
						<div class="row">
							...
							<div class="col-lg-5 d-none d-lg-block bg-register-image"><img src="../Images/p487.jpg"></div>
								<div class="col-lg-7">
						  ...
						  <center> <img class="img-fluid" height="200" width="200"  src="../teacher/upload/<?php echo $row['file'] ?>"></center>
                            
				 
                        
                            
                                 <h5 class="iq-tw-6"><center><div class="panel-head"><?php echo $row['teach_name']; ?></div></center></h5>
...
<br>
 <div class="navigation ">		 
<div class="panel-he"><center><P style="font-size:25px;color:white;text-align:center">"When you feel like quitting, think about why you started</p></center></div>
 </div>
