          ...
          <div class="navigation ">
            <nav>
              ...
              <li ><a href="classes.html">Our classes</a></li>
               <li class="current"><a href="staff.html">Our Team</a></li>
...
?>
	...
	<br>
	  <div class="navigation ">				  
				  <div class="panel-head"><center><P style="font-size:20px;color:white;text-align:center">"LET US READ, AND LET US DANCE; THESE TWO AMUSEMENTS WILL NEVER DO ANY HARM TO THE WORLD.”</p></center></div>
		<br> </div> 	
