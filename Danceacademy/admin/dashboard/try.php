...
<?php $query =mysqli_query($con,"SELECT * FROM tbl_postoff");
                        ...
                        <input type="password" class="form-control" value="<?php echo $a['password']; ?>" name="pswrd" id="pass" placeholder="Create Password" onblur="validate4()" required/>
                        <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                        </div>
                        <input type="password" class="form-control" value="<?php echo $a['password']; ?>" id="cpawd" name="confirm" onblur="validcpass()"  placeholder="Confirm Password" required/>
                        </div>
