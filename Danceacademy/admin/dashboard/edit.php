            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">View Category <a href="#" data-toggle="modal" data-target="#AddLocation"
...
<label for="exampleInputEmail">Category Name</label>
                           <input type="text" id="inputName" class="form-control"  placeholder="Enter Category Name" name="address" autofocus="autofocus" required value="<?php echo $fin['category_name']; ?>">
                           </div>
                           </div>
...
<div class="form-label-group">
<input type="text" id="inputName" class="form-control" placeholder="Enter Cateogry Name" name="address" autofocus="autofocus" required>
</div>
</div>
<div class="modal-footer">
<button type="button" class="btn btn-default" data-dismiss="modal">
...
$query = "insert into tbl_labour_category(category_name) values('$address')";
mysqli_query($con,$query)or die (mysqli_error($con));
