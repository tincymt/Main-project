...
<ul class="navbar-nav ml-auto">
               ...
               <?php
				$con=mysqli_connect("localhost","root","","dancedb") or die("COULDN'T CONNECT");
                    $query = "select t.teach_name,l.leave_id,l.login_id,l.date,l.reason,l.usertype,l.status from tbl_teacher t,tbl_leave l where t.login_id=l.login_id and usertype='teacher'";
                               ...
                               echo "<td>".$fin['leave_id']."</td><td>"
                         				 ...
                         				 if($fin['status'] == 0 || $fin['status'] =='')
                             	 {
                             		 ...
                             		 echo "<a href='approve_teach_leave.php?x=" .$fin['leave_id']." '>deactivated</a>";
                             		 }
                             		 else
                             		 	{
