								...
								<div class="card card-body">
									<div class="bg-white py-2 collapse-inner rounded">
										<h6 class="collapse-header">Teacher Details:</h6>
											<a class="collapse-item" href="addteachers.php">Add Teachers</a>
					...
					<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">Dancetypes::</h6>
								<a class="collapse-item" href="adddance.php">Add Dancestyle</a>
								<a class="collapse-item" href="danceview.php">View Dancestyle</a>
        ...
        <div class="container-fluid">
          <div id="layoutSidenav_content">
				<main>
						...
						<div class="container-fluid">
							<h1 class="mt-4">Add Dance Style</h1>
								<ol class="breadcrumb mb-4">
									<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
										<li class="breadcrumb-item active">Dance Style</li>
								</ol>
												...
												<div class="container">
													<div class="d-flex justify-content-center h-100">
														<div class="card" id="qq">
															<div class="card-header" style="background:#ae9eff">
																<h3><center>Add Dance Style</center></h3>
															</div>
															<div class="card-body" style="background:#ecf0f1">
																<form action="adddancestyle.php" method="POST">
																	 <div class="input-group form-group">
																		...
																		<input type="text" required class="form-control" id="nam" name="danstyle" placeholder="New Dance Style" onblur="validname()">
																	</div>
