					...
					<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header">Dancetypes::</h6>
								...
								<a class="collapse-item" href="approvebook.php">approve book</a>
						</div>
					</div>
				</li>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                              ...
                              <form action="addreg.php" method="POST">
                               ...
                               echo "<tr><th>Sl No</th><th>Student Name</th><th>Email Id</th><th>Address</th><th>Date Of Birth</th><th>Phone No</th><th>status</th></tr>";
