...
<div class="container-fluid">
   ...
   <img src="user/images/r2.png">
        
		
		    </div>
    <div class="clear"></div>
  </div>
		<div class="navbar-header"><img src="user/images/l1.png">
          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
			   ...
			   <li ="float: left"><a href="contacts.html">Contacts</a></li>
			   <a href="course.php">our classes</a></li>
             </ul>
            </nav>
            <div class="clear"></div>
          </div>
