	 ...
	 <div class="container_12">
		<div class="grid_12">
              ...
              <!--Form-->
				...
				<center>...VIEW PROFILE...</center></div>	</div></h2>
						<div class="row">
				...
				&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $result['teach_name']; ?></h3>
				</div>
				
				 <div class="input-group form-group">
				<h3 style="color:white">Address
				&nbsp;:&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $result['teach_address']; ?></h3>
				</div>
				
				<div class="input-group form-group">
				<h3 style="color:white">CONTACT
				&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<?php echo $result['teach_contact']; ?></h3>
				</div>
				...
				<div class="input-group form-group">
				<h3 style="color:white">QUALIFICATION 
			    &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			     <?php echo $result['qualification'];?></h3>
				</div>
				<div class="input-group form-group">
				<h3 style="color:white">COURSE NAME 
			    &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			     <?php echo $result['course_name'];?></h3>
				</div>
				<div class="input-group form-group">
				<h3 style="color:white">duration &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    &nbsp;&nbsp; &nbsp;&nbsp;
			     <?php echo $result['duration'];?></h3>
				</div>
				<div class="input-group form-group">
				<h3 style="color:white">time :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    &nbsp;&nbsp;
			     <?php echo $result['time'];?></h3>
				</div>
...
"THE ONLY WAY TO MAKE SENSE OUT OF CHANGE IS TO PLUNGE INTO IT, MOVE WITH IT, AND JOIN THE DANCE"</p></center></div>
 </div>   <BR>
 <BR>
      <div class="clear"></div>
