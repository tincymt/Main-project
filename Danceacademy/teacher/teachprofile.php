  ...
  <div class="container_12">
   ...
   <li class=" dropdown">
	...
	<br><br><br>
	 ...
	 <form action="addteacherprofile.php" method="POST" enctype="multipart/form-data">
	 <div class="container_12">
		<div class="grid_12">
              ...
              <!--Form-->
				 ...
				 <div class="navigation "><center>...	EDIT PROFILE...</center></div>	</div></h2>
						<div class="row">
		...
		<div class=" form-group">
									<div class="navigation ">	  	<p style="color:white;tex">NAME :</div>
										<input type="text" required class="form-control" id="nam" name="name" value="<?php echo $result['teach_name']; ?>" placeholder="Your name" onblur="validname()">
								...
								<div class="navigation ">	  	<p style="color:white;tex">ADDRESS:</P></div>
										 ...
										 <input type="text" class="form-control" value="<?php echo $result['teach_address']; ?>" name="address" id="address1" placeholder="Home Address" onblur="validate6()"  required/>
									</P></div>
				
								
											<div class=" form-group">
												<div class="navigation ">	  	<p style="color:white;tex">EMAIL:</P>	</div>
									...
									<div class="form-group ">
										...
										<div class="navigation ">	  	<p style="color:white;tex">PHONE NUMBER:</P></div>
										 <input type='number' required class="form-control" placeholder="Contact Number" id="phno" value="<?php echo $result['teach_contact']; ?>"name="contactno" onblur="validate2()"required> 
									...
									<div class="form-group">
										<div class="navigation ">	  	<p style="color:white;">QUALIFICATION:</P>	</div>
...
"YOU CAN DANCE ANYWHERE, EVEN IF ONLY IN YOUR HEART."</p></center></div>
 </div>   <BR>
 <BR>
      <div class="clear"></div>
