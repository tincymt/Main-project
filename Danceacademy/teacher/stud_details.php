...
{
$get_id=$_GET['id'];
$get_post="select * from tbl_studreg where login_id='$get_id'";
$c=mysqli_query($con,$get_post);
...
<div class="container_12">
		<div class="grid_12">
			...
			<h2><div class="panel-heading"> <div class="navigation ">
				<center>...STUDENT PROFILE...</center></div></div></h2>
					<div class="card o-hidden border-0 shadow-lg my-5">
						<div class="row">
							<div class="col-lg-5 d-none d-lg-block bg-register-image"><img src="../Images/p7.jpg"></div>
								<div class="col-lg-7">
