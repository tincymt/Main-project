   ...
   <li class=" dropdown">
    ...
    <a href="approve_student_leave.php">Student Leave</a></li> 
        ...
        <li><a href="course_material_teacher.php">Course Material</a></li>
               ...
               <li  class="current"><a href="staff.php">Our Team</a></li>
...
<h2><div class="panel-heading"><center>  <div class="navigation ">...OUR TEAM...</center></div></h2>        
...
IT IS GLORY ON EARTH AND IT IS YOURS FOR THE TAKING"</p></center></div>
 </div> 
      <div class="clear"></div>
     <div class="clear"></div>
