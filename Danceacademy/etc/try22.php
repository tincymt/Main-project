...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT email FROM tbl_studreg WHERE email=:email and contactnoNumber=:contactno";
...
if($query -> rowCount() > 0)
{
$con="update tbl_login set Password=:newpassword where email=:email and contactnoNumber=:contactno";
...
echo "<script>alert('email id or contactno no is invalid');</script>"; 
}
}
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('imges/pic50.jpg');">
                            ...
                            <div class="content content-full">
                                ...
                                <form class="js-validation-signin px-30" method="post" name="chngpwd" onSubmit="return valid();">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input type="text" class="form-control"  name="contactno" required="true" maxlength="10" pattern="[0-9]+">
                                                <label for="login-password">contactno Number</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
